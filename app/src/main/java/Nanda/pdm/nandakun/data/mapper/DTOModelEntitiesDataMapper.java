package Nanda.pdm.nandakun.data.mapper;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

import Nanda.pdm.nandakun.data.api.ITMDbServiceAPI;
import Nanda.pdm.nandakun.data.api.entity.CreditsListingDTO;
import Nanda.pdm.nandakun.data.api.entity.GenreListingDTO;
import Nanda.pdm.nandakun.data.api.entity.MovieDTO;
import Nanda.pdm.nandakun.data.api.entity.MovieListingDTO;
import Nanda.pdm.nandakun.model.Actor;
import Nanda.pdm.nandakun.model.Crew;
import Nanda.pdm.nandakun.model.Genre;
